...
document.getElementById('by-table').addEventListener('click', () => handleChangeVision('table'));
...
function loadEvents(search) {
  ...
  if (events.length != 0) {
    ...
    const eventRowTemplate = document.getElementById('event-table-row-template').content;
